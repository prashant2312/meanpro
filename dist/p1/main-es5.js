...
var routes = [
    ...
    {
        path: 'showdata/:productid', component: _showdata_showdata_component__WEBPACK_IMPORTED_MODULE_11__["ShowdataComponent"]
    },
    {
...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.http.get(apiurl).subscribe(function (Response) {
            ...
            _this.products = Response['details'];
        }, function (error) {
...
var FindComponent = /** @class */ (function () {
    function FindComponent(http, toastr) {
        this.http = http;
        this.toastr = toastr;
        this.productid = '';
    }
    ...
    FindComponent.prototype.find = function () {
        var _this = this;
        var req = {
            productid: this.productid
        };
        console.log('you entered', req);
        this.http.post(apiurl, req).subscribe(function (Response) {
            if (Response['code'] == 1100) {
                console.log('product found');
                _this.toastr.success('product found');
            }
            if (Response['code'] == 1300) {
                _this.toastr.warning('please enter sufficient data');
            }
        }, function (error) {
            _this.toastr.error('no response');
        });
    };
...
var FindallComponent = /** @class */ (function () {
    function FindallComponent(http, toastr) {
        this.http = http;
        this.toastr = toastr;
    }
    FindallComponent.prototype.ngOnInit = function () {
    };
    FindallComponent.prototype.findall = function () {
        var _this = this;
        this.http.get(apiurl).subscribe(function (Response) {
            _this.toastr.success('request is sent');
            console.log(" found", Response);
        }, function (error) {
            _this.toastr.error('did not found');
        });
    };
...
var ForgotComponent = /** @class */ (function () {
    function ForgotComponent(http, toastr, router) {
        this.http = http;
        this.toastr = toastr;
        this.router = router;
        this.email = '';
    ...
    ForgotComponent.prototype.forgot = function () {
        ...
        this.http.post(apiurl, req).subscribe(function (Response) {
            ...
            if (Response['code'] == 1400) {
                _this.toastr.success('password send');
                _this.router.navigate(['/login']);
            }
            if (Response['code'] == 1500) {
                _this.toastr.warning('give emailaddres');
            }
            if (Response['code'] == 1300) {
                _this.toastr.warning('user not found');
            }
        }, function (error) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.http.post(apiurl, request).subscribe(function (Response) {
            _this.toastr.success('response came');
            console.log("response from login api", Response);
            if (Response['code'] == 200) {
                _this.router.navigate(['/']);
                localStorage.name = Response['name'];
                localStorage.email = Response['email'];
                _this.toastr.success('email:' + _this.email);
                _this.toastr.success('password:' + _this.password);
            }
            if (Response['code'] == 9900) {
                _this.toastr.warning('enter  sufficient details');
            }
            else {
...
var ProComponent = /** @class */ (function () {
    function ProComponent(http, toastr) {
        this.http = http;
        this.toastr = toastr;
        this.productname = '';
        this.productrate = '';
    ...
    ProComponent.prototype.pro = function () {
        var _this = this;
        var request = {
        ...
        this.http.post(apiurl, request).subscribe(function (Response) {
            ...
            if (Response['code'] == 1200) {
                _this.toastr.warning('dublicate entry');
            }
            if (Response['code'] == 1400) {
                _this.toastr.success('product entered');
            }
        }, function (error) {
            _this.toastr.error('product didnot placed');
        });
    };
...
var RemoveComponent = /** @class */ (function () {
    function RemoveComponent(http, toastr, router) {
        this.http = http;
        this.toastr = toastr;
        this.router = router;
        this.email = '';
    ...
    RemoveComponent.prototype.remove = function () {
        var _this = this;
        var req = {
            email: this.email
        };
        ...
        this.http.post(apiurl, req).subscribe(function (Response) {
            if (Response['code'] == 1100) {
                ...
                _this.toastr.success('user removed');
                _this.router.navigate(['/']);
            }
            if (Response['code'] == 1234) {
                _this.toastr.success('send email');
            }
        }, function (error) {
            console.log('error in parsing to server');
        });
...
var ShowdataComponent = /** @class */ (function () {
    function ShowdataComponent(http, activatedroute, toastr, router) {
        var _this = this;
        this.http = http;
    ...
    ShowdataComponent.prototype.addtocart = function () {
        var _this = this;
        if (localStorage.email) {
            var reqobj = {
            ...
            this.http.post(addtocartapi, reqobj).subscribe(function (Response) {
                if (Response['code'] == 1290) {
                    _this.toastr.success('product added to cart');
                }
            }, function (error) {
                _this.toastr.warning('error in adding to cart');
            });
        }
        else {
    ...
    ShowdataComponent.prototype.buynow = function () {
        if (localStorage.email) {
            this.addtocart();
    ...
    SignupComponent.prototype.signup = function () {
        ...
        this.http.post(apiurl, request).subscribe(function (Response) {
            ...
            if (Response['code'] == 2500) {
                _this.toastr.success('signup done');
                _this.router.navigate(['/login']);
            }
            if (Response['code'] == 4400) {
                _this.toastr.success('account exist');
                _this.router.navigate(['/login']);
            }
            if (Response['code'] == 1800) {
                _this.toastr.warning('dublicate email');
            }
        }, function (error) {
            console.log('error in parsing to server');
        });
